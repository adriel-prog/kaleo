  ...
  const renderContent = () => {
    ...
    return (
      <div className="flex flex-wrap justify-center gap-10">
        {members.map((member) => (
          <div key={member.id} className="text-center group transition-transform duration-300 ease-in-out hover:!opacity-100 group-hover:opacity-50 hover:-translate-y-2">
